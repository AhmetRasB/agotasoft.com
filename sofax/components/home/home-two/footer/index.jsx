					...
					<div className="row">
						<div className="col-xl-4 col-md-12">
							<div className="sofax-footer-wrap mr-15 light-color">
								...
								<p>
									AgotaSoft, işletmelerin dijital dönüşüm yolculuğunda güvenilir teknoloji partneridir. 
									ERP, CRM, Ön Muhasebe ve LMS çözümlerimizle verimliliğinizi artırıyoruz.
								</p>
